                    ...
                    <li>
                        <div className="border-t-slate-400  border-b-2 h-32 justify-between flex m-9"  >
                            ...
                            <div className="border-solid border  h-32 border-slate-100 bg-gray-950 rounded-lg ">
                                ...
                                <button className="border-solid border border-slate-300 rounded-sm text-green-400 h-6 w-16 bg-white font-semibold ml-8">ADD<span className="pb-6">+</span></button>
